...
document.addEventListener(
  ...
  function() {
    ...
    var body = document.querySelector("body"),
      ...
      pageHeaderTopBar = document.querySelector(
        ".page-header:not(.left-bar):not(.bottom-bar-mobile)"
      ),
      pageHeaderBottomMobile = document.querySelector(
        ".page-header.bottom-bar-mobile"
      ),
    ...
    var toggleNav = function toggleNav(event) {
      ...
      while (i < pageNav.length) {
        if (pageNav[i].id == dataTriggerNav)
          body.classList.contains("menu-opened")
    ...
    if (pageNavOverlay) pageNavOverlay.addEventListener("click", closeNav);
    ...
    var toggleSubNav = function toggleSubNav(event) {
      ...
      if (pageHeaderBottomMobile && window.innerWidth > 1024)
        event.preventDefault();
  ...
  function() {
    ...
    if (document.getElementById("pageModals")) {
      var pageModals = document.getElementById("pageModals"),
        ...
        triggerCloseModal = document.getElementsByClassName(
          "triggerCloseModal"
        ),
    ...
    /********** component collapse **********/
    var boxCollapseTrigger = document.querySelectorAll(
        ".box-collapse .box-collapse-trigger button"
      ),
      boxCollapseContent = document.querySelectorAll(
        ".box-collapse .box-collapse-content"
      );
    ...
    if (document.getElementById("tabsWrapper")) {
      var tabsTriggers = document.querySelectorAll(
          '.tabs-wrapper [role="tab"]'
        ),
        tabsPanels = document.querySelectorAll(
      ...
      if (window.innerWidth > 640) {
        ...
        tabsWrapper.style.height =
          document.querySelector('[aria-selected="true"]').nextElementSibling
            .clientHeight +
          100 +
          "px";
      }
      ...
      var toggleTabsContent = function toggleTabsContent(event) {
        ...
        if (window.innerWidth > 640) {
          // set height to tabsWrapper depending of panel height + 100px
          tabsWrapper.style.height =
            document.getElementById(ariaControls).clientHeight + 100 + "px";
        }
